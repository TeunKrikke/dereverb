...
def do_reverb(s1):
    """
        Apply reverb to the sound signal by simulating a room
    """
...
def do_stft(s1, room):
    """
     Convert the signals to the frequency domain
    """
    nfft=2048
    win = 1024
    hop = int(nfft/8)
...
def do_reverb_oldskool(s1, rt60=0.4):
    """
    apply the reverb and use RT time
    """
...
def do_stft_oldskool(s1, m1, m2):
    """
        convert the signals to the STFT domain
    """
    nfft=2048
    win = 1024
    hop = int(nfft/8)
